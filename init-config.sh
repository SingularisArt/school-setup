...
root: ${ROOT}
current_course: ${HOME}/Documents/notes/school-notes/current-course
master_file: ${HOME}/Documents/notes/school-notes/current-course/master.tex
source_lessons_location: ${HOME}/Documents/notes/school-notes/current-course/source-lectures.tex
